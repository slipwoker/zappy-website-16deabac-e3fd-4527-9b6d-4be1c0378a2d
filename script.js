document.addEventListener('DOMContentLoaded', function() {
    ...
    if (animatedElements.length > 0) {
        function isElementInViewport(el, offset) {
            ...
            return rect.top <= windowHeight - (offset || 100) && rect.bottom >= 0;
        }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '16deabac-e3fd-4527-9b6d-4be1c0378a2d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '16deabac-e3fd-4527-9b6d-4be1c0378a2d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '16deabac-e3fd-4527-9b6d-4be1c0378a2d';
